...
SECRET_KEY = '0#!8#bg+nu0&mteym5qy=25=ww0bi134es728a0rz2mqyq001%'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'carshare', 'static'),
    os.path.join(BASE_DIR, 'blog', 'static'),
    os.path.join(BASE_DIR, 'homep', 'static'),
